...
from controllers.kuka_circle_CSSQP import KukaCircleCSSQP
...
ctrl = KukaCircleCSSQP(head, pin_robot, config, run_sim=SIM)
# ctrl.warm_start(100)
...
if SIM:
    ...
    thread_head.start_logging(10, "/tmp/kuka_circle_sim_circle_.mds")
    thread_head.sim_run_timed(100000)
    # thread_head.stop_logging()
    thread_head.plot_timing()
else:
    thread_head.start()
    # thread_head.start_logging(30, "/home/skleff/Desktop/data_paper_CSSQP/circle_no_cstr/no_constraint_"+str(time.time())+".mds")
    # thread_head.start_logging(30, "/home/skleff/Desktop/data_paper_CSSQP/circle_jointpos_cstr/jointPos_constraint=0.05_"+str(time.time())+".mds")
    # thread_head.start_logging(30, "/home/skleff/Desktop/data_paper_CSSQP/circle_jointpos_cstr/jointPos_constraint_"disturbance_+str(time.time())+".mds")
    # thread_head.start_logging(30, "/home/skleff/Desktop/data_paper_CSSQP/circle_endeff_cstr/endeff_constraint_D_"+str(time.time())+".mds")
    thread_head.start_logging(30, "/home/skleff/Desktop/data_paper_CSSQP/circle_endeff_cstr/endeff_constraint_plane_cost_disturbance_"+str(time.time())+".mds")
    time.sleep(30)
    # thread_head.plot_timing()
