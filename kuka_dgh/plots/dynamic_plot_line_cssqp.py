...
data_name = 'line_cssqp_REAL_2023-10-23T15:13:37.129836_cssqp' # <<<<<<<<<<<<< Choose data file here 
            # 'line_cssqp_REAL_2023-10-23T15:15:34.911408_cssqp_PUSH'
...
# Constraints
line_cstr  = ax.axvline(p_lb[1], xmin=0, xmax=0, color='k', animated=True, linewidth=LINEWIDTH, linestyle='--', label='Constraint', alpha=0.6) 
# These are not plt.lines.line2D but plt.patches.polygon objects
poly_cstr = ax.axspan(-MAX_XY, p_lb[2], -MAX_XY, -MAX_XY, animated=True, color='gray', alpha=0.2, lw=0)   
